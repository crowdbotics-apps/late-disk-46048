"""
Django settings for late_disk_46048 project.
...
ROOT_URLCONF = 'late_disk_46048.urls'
...
WSGI_APPLICATION = 'late_disk_46048.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_disk_46048 API",
    "DESCRIPTION": "API documentation for late_disk_46048 App",
    "VERSION": "v1",
}
